            ...
            <form @submit.prevent="activeTab = 'dieta'">
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" v-model="form.name" required placeholder="Ej: Juan Pérez" />
                </div>
                <div class="col-md-3">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="email" class="form-control" v-model="form.email" placeholder="ejemplo@correo.com" required />
                </div>
                <div class="col-md-6">
                  <label class="form-label fw-semibold">Teléfono</label>
                  <input type="text" class="form-control" v-model="form.phone" placeholder="+54 11 2345 6789" />
                </div>
              </div>
            ...
            <form @submit.prevent="activeTab = 'dietas'">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  ...
                  <textarea class="form-control" v-model="form.preferences" rows="2" placeholder="Ej: vegetariano, sin gluten..."></textarea>
                </div>
              </div>
...
export default {
  ...
  methods: {
      ...
      this.axiosPost({
        ...
        .then(response => {
          if (response.data.status === 'success' || response.data.status === true) {
            ...
            this.$toastr.s('✅ Usuario guardado correctamente.');
            this.activeTab = 'dietas';
          } else {
            this.$toastr.e('⚠️ No se pudo guardar el usuario.');
          }
        })
        .catch(error => {
          console.error(error);
          this.$toastr.e(error.response?.data?.message || 'Error de conexión con el servidor.');
        })
        .finally(() => {
    ...
    /**
     * Genera una dieta con IA y guarda el PDF
     */
    generateDiet() {
      if (!this.userId) {
