...
Vue.component('tab-setting1', require('./Components/Views/Demo/UI/tabs/components/TabSetting').default);
Vue.component('tab-setting2', require('./Components/Views/Demo/UI/tabs/components/TabSetting').default);
Vue.component('tab-setting3', require('./Components/Views/Demo/UI/tabs/components/TabSetting').default);
Vue.component('tab-setting4', require('./Components/Views/Demo/UI/tabs/components/TabSetting').default);
Vue.component('tab-setting5', require('./Components/Views/Demo/UI/tabs/components/TabSetting').default);
...
Vue.component('loader-page', require('./Components/Views/Demo/UI/loader/index.vue').default);
...
Vue.component('report', require('./Components/Views/Demo/Pages/report/index.vue').default);
...
Vue.component('template-view', require('./Components/Views/Demo/Pages/template/Index.vue').default);
Vue.component('job-post-view', require('./Components/Views/Demo/Pages/job-post/CandidateJobPost.vue').default);
