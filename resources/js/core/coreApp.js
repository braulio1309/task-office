...
Vue.component('app-skeleton-loader', require('./components/preloders/SkeletonLoader.vue').default);
...
Vue.component('app-tab-group', require('./components/tabs-group/index').default);
